...
export default function CartDeliveryScreen({ navigation }) {
    ...
    const { items, total, clearCart, voucher } = useCart()
            ...
            >
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    ...
                    <View style={styles.form}>
                        ...
                        {/* <Text style={styles.totalText}>Total: {total.toFixed(2)} €
            {voucher && " (20% discount applied)"}</Text> */}
                        <Text style={styles.totalText}>
                            Total: {total.toFixed(2)} €
                            {voucher && ` (${voucher.discount * 100}% discount applied)`}
                        </Text>
