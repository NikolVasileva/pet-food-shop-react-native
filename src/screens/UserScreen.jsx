...
export default function UserScreen() {
    const { user, logout } = useAuth(); // взимаме логнатия потребител
    const [email, setEmail] = useState(user?.email || "");
    const [isEditing, setIsEditing] = useState(false); // контрол за редактиране
    ...
    const saveEmail = () => {
        ...
        setIsEditing(false);
        // Тук можеш да добавиш логика за актуализиране на имейла в бекенд
    };
